...
const moralisapikey = "KyHb0lZPHM3zBn9GBy29NaREUiJv1VH6FNXS5aLCYZmBYdTI08LwrfQEZNrsYt3Y";
...
class App extends Component {
  ...
  return (
    <div className="App nftapp">
        <nav class="navbar navbarfont navbar-expand-md  mb-4">
        ...
        <div className='container container-style'>
          ...
          <form>
            ...
            >
              <Button variant='dark' value="1">1</Button>
              <Button variant='dark' value="2">2</Button>
              <Button variant='dark' value="3">3</Button>
              <Button variant='dark' value="4">4</Button>
              <Button variant='dark'value="5">5</Button>
            </ButtonGroup>
            ...
            <div className="row px-2 pb-2 row-style">
              <div className="col ">
                <Button variant='dark' className="button-style" style={{ border: "0.2px", borderRadius: "14px", boxShadow: "1px 1px 5px #000000" }}>
        ...
        <div className='col'>
          <body className='nftstaker border-0'>
            <form  style={{ fontFamily: "SF Pro Display" }} >
              ...
              <Button  variant='dark' className="btn mb-3" style={{ backgroundColor: "#ffffff10", boxShadow: "1px 1px 5px #000000" }} >Authorize Your Wallet</Button><span></span>
                ...
                <div className="col">
                  <form class="stakingrewards" style={{ borderRadius: "25px", boxShadow: "1px 1px 15px #ffffff" }}>
                    ...
                    <table className='table mt-3 mb-5 px-3 table-dark'>
                      ...
                      <tr>
                        <td>
                        <Button className='mb-3' style={{ backgroundColor: "#ffffff10", boxShadow: "1px 1px 5px #000000" }}>Unstake All</Button></td>
                      </tr>
                    </table>
                  </form>
                </div>
